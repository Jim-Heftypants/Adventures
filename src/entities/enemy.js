...
// rdps
const tutorialWizard = new classCreator('EWizard', 'infinite', 60, 10, 1500, 10, false, 'e1', [500, 500], 8);
...
// heals
const tutorialCleric = new classCreator('ECleric', 'infinite', 60, 10, 2000, -8, false, "e4", [1000, 100], 8)
...
// mdps
const tutorialRogue = new classCreator("ERogue", 10, 60, 10, 1200, 7, false, "e2", [700, 200], 14);
...
// tank
const punchingBag = new classCreator('EWarrior', 10, 100, 10, 1000, 1, false, "e3", [300, 400], 20);
const tutorialWarrior = new classCreator('EWarrior', 10, 100, 10, 1000, 6, false, "e3", [300, 400], 20);
